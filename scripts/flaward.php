...
if ($conn->connect_error) {
 ...
 //$sql = "Select user_id,flnm,new_name,section_id,award_id from marks";  // For all Images
  ...
  $sql = "Select user_id,name,theme_id,circuit_id from award_det  where award_id > 0";  // For awarded Images
 ...
 //exit();
  ...
  $bflpath = "../files/Digital";	
	...
	if     ($section == 3)
      $target     = $basepath."/"."Award/Colour/".$trgpth;    
    elseif ($section == 4)
	  $target     = $basepath."/"."Award/Mono/".$trgpth; 
    elseif ($section == 5)  
	  $target     = $basepath."/"."Award/Nature/".$trgpth; 
    elseif ($section == 6)  
	  $target     = $basepath."/"."Award/PJ/".$trgpth; 
    elseif ($section == 7)  
	  $target     = $basepath."/"."Award/PT/".$trgpth; 
